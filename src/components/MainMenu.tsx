...
const translations = {
  en: {
    ...
    race: 'Online race', note: 'Guest mode starts instantly without registration.',
  },
  ru: {
    ...
    race: 'Онлайн-гонка', note: 'Гостевой режим запускается сразу без регистрации.',
  },
  kk: {
    ...
    race: 'Онлайн жарыс', note: 'Қонақ режимі тіркелусіз бірден басталады.',
  },
} satisfies Record<Language, Record<string, string>>

export function MainMenu({ hasAccount, onAccount, onGuest, onMultiplayer, language, onLanguageChange }: Props) {
